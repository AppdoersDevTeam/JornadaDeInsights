            ...
            <div className="lg:w-2/5">
              <div className="relative">
                ...
                <div className="absolute bottom-4 right-4 flex gap-2">
                  ...
                  <a href="https://open.spotify.com/show/033dE0OxeExcL0bM8Q9AcT" target="_blank" rel="noopener noreferrer" className="bg-white p-2 rounded-full shadow-md text-muted-foreground transition-transform transition-colors hover:scale-110 hover:text-primary footer-icon">
