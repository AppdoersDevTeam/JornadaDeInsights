          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12">
            ...
            <div>
              ...
              <div className="flex space-x-4">
                ...
                <a href="https://open.spotify.com/show/033dE0OxeExcL0bM8Q9AcT" target="_blank" rel="noopener noreferrer" aria-label="Spotify" className="bg-primary/10 p-3 rounded-full transition-all duration-300 hover:bg-primary/20 hover:-translate-y-1 hover:shadow-lg">
